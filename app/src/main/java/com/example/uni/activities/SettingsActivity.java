...
import com.example.uni.databinding.ActivitySettingsBinding;
...
public class SettingsActivity extends BaseActivity {
    ...
    private void setSwitchStatus(){
        if (preferenceManager.getBoolean(Constants.STATUS)){
            ...
            binding.settingsActivityButtonOnlineText.setTextColor(getResources().getColor(R.color.colorPrimary));
            ...
            binding.settingsActivityButtonOnlineText.setTextColor(getResources().getColor(R.color.colorGray));
            InitFirebase.firebaseFirestore.collection(Constants.USERS).document(preferenceManager.getString(Constants.USER_ID))
    ...
    private void setListeners(){
        ...
        binding.settingsActivityButtonSignOut.setOnClickListener(view -> showDialogSignOut());
    }
